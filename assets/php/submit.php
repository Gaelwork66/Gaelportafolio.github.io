...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->addAddress("gaelpc66@gmail.com", "gael"); // (Your Mail) An email address that will receive the email with the output of the form

	$mail->IsHTML(true); // Set email format to HTML

	$mail->Subject = "(Gael) New Contact Info";
	$mail->Body = $html;
